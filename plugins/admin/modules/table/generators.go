...
import (
	...
	"github.com/HongJaison/go-admin4/modules/collection"
	"github.com/HongJaison/go-admin4/modules/config"
	"github.com/HongJaison/go-admin4/modules/db"
	"github.com/HongJaison/go-admin4/modules/db/dialect"
	errs "github.com/HongJaison/go-admin4/modules/errors"
	"github.com/HongJaison/go-admin4/modules/language"
	"github.com/HongJaison/go-admin4/modules/logger"
	"github.com/HongJaison/go-admin4/modules/ui"
	"github.com/HongJaison/go-admin4/modules/utils"
	"github.com/HongJaison/go-admin4/plugins/admin/models"
	form2 "github.com/HongJaison/go-admin4/plugins/admin/modules/form"
	"github.com/HongJaison/go-admin4/plugins/admin/modules/parameter"
	"github.com/HongJaison/go-admin4/plugins/admin/modules/tools"
	"github.com/HongJaison/go-admin4/template"
	"github.com/HongJaison/go-admin4/template/types"
	"github.com/HongJaison/go-admin4/template/types/action"
	"github.com/HongJaison/go-admin4/template/types/form"
	selection "github.com/HongJaison/go-admin4/template/types/form/select"
...
func (s *SystemTable) GetGenerateForm(ctx *context.Context) (generateTool Table) {
	...
	formList.AddField(lgWithScore("extra import package", "tool"), "extra_import_package", db.Varchar, form.Select).
		FieldOptions(types.FieldOptions{
			...
			{Text: "log", Value: "log"},
			{Text: "fmt", Value: "fmt"},
			{Text: "github.com/HongJaison/go-admin4/modules/db/dialect", Value: "github.com/HongJaison/go-admin4/modules/db/dialect"},
			{Text: "github.com/HongJaison/go-admin4/modules/db", Value: "github.com/HongJaison/go-admin4/modules/db"},
			{Text: "github.com/HongJaison/go-admin4/modules/language", Value: "github.com/HongJaison/go-admin4/modules/language"},
			{Text: "github.com/HongJaison/go-admin4/modules/logger", Value: "github.com/HongJaison/go-admin4/modules/logger"},
		}).
		FieldDefault("").
