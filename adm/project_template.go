...
import (
	...
	_ "github.com/HongJaison/go-admin4/adapter/gin"                    // web framework adapter
	_ "github.com/HongJaison/go-admin4/modules/db/drivers/{{.DriverModule}}" // sql driver
	_ "github.com/HongJaison/themes4/{{.Theme}}"                       // ui theme
...
import (
	...
	_ "github.com/HongJaison/go-admin4/adapter/beego"                   // web framework adapter
	_ "github.com/HongJaison/go-admin4/modules/db/drivers/{{.DriverModule}}"  // sql driver
	_ "github.com/HongJaison/themes4/{{.Theme}}"                        // ui theme
...
import (
	...
	_ "github.com/HongJaison/go-admin4/adapter/buffalo"                 // web framework adapter
	_ "github.com/HongJaison/go-admin4/modules/db/drivers/{{.DriverModule}}"  // sql driver
	_ "github.com/HongJaison/themes4/{{.Theme}}"                        // ui theme
...
import (
	...
	_ "github.com/HongJaison/go-admin4/adapter/chi"                 // web framework adapter
	_ "github.com/HongJaison/go-admin4/modules/db/drivers/{{.DriverModule}}"  // sql driver
	_ "github.com/HongJaison/themes4/{{.Theme}}"                        // ui theme
...
import (
	...
	_ "github.com/HongJaison/go-admin4/adapter/echo"                 // web framework adapter
	_ "github.com/HongJaison/go-admin4/modules/db/drivers/{{.DriverModule}}"  // sql driver
	_ "github.com/HongJaison/themes4/{{.Theme}}"                        // ui theme
...
import (
	...
	_ "github.com/HongJaison/go-admin4/adapter/fasthttp"                 // web framework adapter
	_ "github.com/HongJaison/go-admin4/modules/db/drivers/{{.DriverModule}}"  // sql driver
	_ "github.com/HongJaison/themes4/{{.Theme}}"                        // ui theme
...
import (
	...
	_ "github.com/HongJaison/go-admin4/adapter/gf"                 // web framework adapter
	_ "github.com/HongJaison/go-admin4/modules/db/drivers/{{.DriverModule}}"  // sql driver
	_ "github.com/HongJaison/themes4/{{.Theme}}"                        // ui theme
...
import (
	...
	_ "github.com/HongJaison/go-admin4/adapter/gorilla"                 // web framework adapter
	_ "github.com/HongJaison/go-admin4/modules/db/drivers/{{.DriverModule}}"  // sql driver
	_ "github.com/HongJaison/themes4/{{.Theme}}"                        // ui theme
...
import (
	...
	_ "github.com/HongJaison/go-admin4/adapter/iris"                 // web framework adapter
	_ "github.com/HongJaison/go-admin4/modules/db/drivers/{{.DriverModule}}"  // sql driver
	_ "github.com/HongJaison/themes4/{{.Theme}}"                        // ui theme
...
import (
	...
	template2 "github.com/HongJaison/go-admin4/template"
	"github.com/HongJaison/go-admin4/template/chartjs"
	"github.com/HongJaison/go-admin4/template/types"
	"github.com/HongJaison/themes4/sword/components/card"
	"github.com/HongJaison/themes4/sword/components/chart_legend"
	"github.com/HongJaison/themes4/sword/components/description"
	"github.com/HongJaison/themes4/sword/components/progress_group"
	"html/template"
)
...
import (
	"github.com/HongJaison/go-admin4/context"
	tmpl "github.com/HongJaison/go-admin4/template"
	"github.com/HongJaison/go-admin4/template/chartjs"
	"github.com/HongJaison/go-admin4/template/icon"
	"github.com/HongJaison/go-admin4/template/types"
	"github.com/HongJaison/themes4/adminlte/components/chart_legend"
	"github.com/HongJaison/themes4/adminlte/components/description"
	"github.com/HongJaison/themes4/adminlte/components/infobox"
	"github.com/HongJaison/themes4/adminlte/components/productlist"
	"github.com/HongJaison/themes4/adminlte/components/progress_group"
	"github.com/HongJaison/themes4/adminlte/components/smallbox"
	"html/template"
)
...
- [github](https://github.com/HongJaison/go-admin4)
