            ...
            <div class="ui middle very relaxed page grid">
                <div class="sixteen wide center aligned centered column">
                    ...
                    <div class="ui attached segment install-success-readme-cn"
                        ...
                        <ul>
                            <li>
                                <a href="https://gitee.com/go-admin4/go-admin4/raw/master/data/admin.sql" target="_blank">Mysql</a>
                            </li>
                            <li>
                                <a href="https://gitee.com/go-admin4/go-admin4/raw/master/data/admin.mssql"
                                   target="_blank">Mssql</a>
                            </li>
                            <li>
                                <a href="https://gitee.com/go-admin4/go-admin4/raw/master/data/admin.pgsql"
                                   target="_blank">Postgresql</a>
                            </li>
                            <li>
                                <a href="https://gitee.com/go-admin4/go-admin4/raw/master/data/admin.db" target="_blank">SQLite3</a>
                            </li>
                        </ul>
                        <p>
                            2. 依次执行以下命令：
...
> make serve</pre>
                            ...
                            <ul>
                                <li>
                                    <span style="font-size:15px;font-weight:normal;">Github：&nbsp;<a
                                                href="https://github.com/HongJaison/go-admin4" target="_blank">https://github.com/HongJaison/go-admin4</a></span>
                                </li>
                                <li>
                    ...
                    <div class="ui attached segment install-success-readme-en"
                        ...
                        <ul>
                            <li>
                                <a href="https://raw.githubusercontent.com/HongJaison/go-admin4/master/data/admin.sql"
                                   target="_blank">Mysql</a>
                            </li>
                            <li>
                                <a href="https://raw.githubusercontent.com/HongJaison/go-admin4/master/data/admin.mssql"
                                   target="_blank">Mssql</a>
                            </li>
                            <li>
                                <a href="https://raw.githubusercontent.com/HongJaison/go-admin4/master/data/admin.pgsql"
                                   target="_blank">Postgresql</a>
                            </li>
                            <li>
                                <a href="https://raw.githubusercontent.com/HongJaison/go-admin4/master/data/admin.db"
