...
func buildProject(cfgFile string) {
	...
	if defaultLang == "cn" || p.Language == language.CN || p.Language == "cn" {
		fmt.Println("- sqlite: " + ansi.Color("https://gitee.com/go-admin4/go-admin4/raw/master/data/admin.db", "blue"))
		fmt.Println("- mssql: " + ansi.Color("https://gitee.com/go-admin4/go-admin4/raw/master/data/admin.mssql", "blue"))
		fmt.Println("- postgresql: " + ansi.Color("https://gitee.com/go-admin4/go-admin4/raw/master/data/admin.pgsql", "blue"))
		fmt.Println("- mysql: " + ansi.Color("https://gitee.com/go-admin4/go-admin4/raw/master/data/admin.sql", "blue"))
	} else {
		fmt.Println("- sqlite: " + ansi.Color("https://github.com/HongJaison/go-admin4/raw/master/data/admin.db", "blue"))
		fmt.Println("- mssql: " + ansi.Color("https://raw.githubusercontent.com/HongJaison/go-admin4/master/data/admin.mssql", "blue"))
		fmt.Println("- postgresql: " + ansi.Color("https://raw.githubusercontent.com/HongJaison/go-admin4/master/data/admin.pgsql", "blue"))
		fmt.Println("- mysql: " + ansi.Color("https://raw.githubusercontent.com/HongJaison/go-admin4/master/data/admin.sql", "blue"))
	}
	fmt.Println()
...
import "github.com/HongJaison/go-admin4/plugins/admin/modules/table"
