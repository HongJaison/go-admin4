...
type Component interface {
	...
	//
	// See:
	// https://github.com/HongJaison/go-admin4/blob/master/template/login/theme1.tmpl#L32
	// https://github.com/HongJaison/go-admin4/blob/master/template/login/list.go
	GetAssetList() []string
