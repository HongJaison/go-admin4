...
See [manual](https://github.com/HongJaison/go-admin4/projects/3) for more information.
...
For now, you need to add your fork as a remote on the original **\$GOPATH**/src/github.com/HongJaison/go-admin4 clone, so:

```bash

$ go get github.com/HongJaison/go-admin4
$ cd $GOPATH/src/github.com/HongJaison/go-admin4 # GOPATH is $HOME/go by default.
...
Notice: `go get` return `package github.com/HongJaison/go-admin4: no Go files in /go/src/github.com/HongJaison/go-admin4` is normal.
...
* **Support on [Open Collective](https://opencollective.com/go-admin4)**
...
* [Tasks](https://github.com/HongJaison/go-admin4/projects)
